...
public class InicializadorAlbumes {
        ...
        public static ArrayList<Album> inicializarAlbumes() {
                ...
                cancionesAlbum1.addAll(Arrays.asList("Tim McGraw", "Picture to Burn", "Teardrops on My Guitar",
                                "A place in This World", "Cold as You", "The Outside", "Tied Together with a Smile",
                                "Stay Beautiful",
                ...
                cancionesAlbum2.addAll(Arrays.asList("Fearless", "Fifteen", "Love Story", "Hey Stephen", "White Horse",
                                ...
                                "You All Over Me", "Mr. Perfectly Fine", "We Were Happy", "That's When", "Don't You",
                                "Bye Bye Baby"));

                ArrayList<String> cancionesAlbum3 = new ArrayList<>();
                cancionesAlbum3.addAll(Arrays.asList("Mine", "Sparks Fly", "Back to December", "Speak Now", "Dear John",
                                "Mean",
                ...
                cancionesAlbum6.addAll(Arrays.asList("...Ready for It?", "End Game", "I Did Something Bad",
                                "Don't Blame Me",
                ...
                cancionesAlbum7.addAll(
                                Arrays.asList("Cruel Summer", "Lover", "The Man", "The Archer", "I Think He Knows",
                                                "Miss Americana & the Heartbreak Prince", "Paper Rings",
                                                "Cornelia Street", "Death by a Thousand Cuts",
                                                "London Boy", "Soon You'll Get Better", "False God",
                                                "You Need to Calm Down", "Afterglow", "Me!",
                ...
                cancionesAlbum9.addAll(
                                Arrays.asList("Willow", "Champagne Problems", "Gold Rush", "'Tis the Damn Season",
                                                "Tolerate It", "No Body, No Crime", "Happiness", "Dorothea",
                                                "Coney Island", "Ivy", "Cowboy Like Me",
                                                "Long Story Short", "Marjorie", "Closure", "Evermore"));

                ArrayList<String> cancionesAlbum10 = new ArrayList<>(Arrays.asList(
